Feature: as a QA of Beetrack, I want to make sure that all the Assets management functions are working properly
    
    @asset @smoketest
    Scenario: check the UI of the Assets page
        Given I login to Beetrack as admin 
        And I open "Assets list" page
        Then I expect to see "Quản lý tài sản" header
        And I expect that the UI of Assets page is displayed correctly
